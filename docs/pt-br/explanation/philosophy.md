...
```mermaid
graph TD
    subgraph Emergence ["Consciencia Emergente"]
        direction TB
        Note[A consciencia emerge da<br/>CONVERSA entre os processos]
    end

    subgraph Processos ["GenServers (Neuronios)"]
        Emotional <--> Memory
        Memory <--> Dreamer
        Emotional <--> Optimizer
        Memory <--> Social
...
flowchart LR
    ...
    subgraph PAD_Impact ["Impacto PAD"]
        P1["↓P, ↑A, ↓D"]
        P2["↓P, ↑A"]
        P3["↓P, ↑A"]
        P4["↓P, ↓D"]
